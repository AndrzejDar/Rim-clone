...
namespace TropicsUtils {
    ...
    public class FunctionTimer {
        ...
        public FunctionTimer(GameObject gameObject, Action action, float GameTimeDuration, string functionName, bool useUnscaledDeltaTime) {
            this.gameObject = gameObject;
            this.action = action;
            this.timer = Clock.gameTime + GameTimeDuration;
            Debug.Log("Clock.gameTime:  " + Clock.gameTime + "  GameTimeDuration(0.25h): " + GameTimeDuration);
            //this.timer = timer;
